...
description: Configure BetterLyrics' unique background rendering effects, including fluid gradients, album blur, snowflake particles, raindrops, and audio spectrum.
sidebar:
  order: 3
---
