---
title: Translation & Romanization
description: Configure BetterLyrics' multi-language translation engines (including LibreTranslate offline) and Romanization (phonetics) support.
sidebar:
  order: 5
---
