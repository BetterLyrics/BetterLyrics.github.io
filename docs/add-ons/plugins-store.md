...
<cardGrid>
  ...
  <linkCard title="CarpeCast" description="A local-network app that syncs Android media playback to Windows with remote control features (Under development)." href="https://github.com/jayfunc/CarpeCast" />
</cardGrid>
